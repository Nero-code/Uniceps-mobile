...
import 'package:uniceps/app/Profile/presentation/screens/gym_profile.dart';
import 'package:uniceps/app/Profile/presentation/widgets/gym_logo_widget.dart';
import 'package:uniceps/app/Profile/presentation/widgets/gyms_list_wave_back.dart';
      ...
      body: PopScope(
        ...
        child: RefreshIndicator(
          ...
          child:
              ...
              //     if (gymstate is GymsLoadedState) {
              //       print("Inside Gyms Bloc 2");
              //       if (gymstate.restList.isEmpty && gymstate.myGyms.isEmpty) {
              //         print("Inside Gyms Bloc 3");
              //         return Center(
              //             child: Text(AppLocalizations.of(context)!.empty));
              //       }
              //       if (gymstate.myGyms.isNotEmpty) {
              //         gym = gymstate.myGyms.first;
              //       }
              //       return
              Stack(
            children: [
