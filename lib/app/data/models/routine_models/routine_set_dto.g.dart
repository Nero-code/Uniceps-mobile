...
RoutineSetDto _$RoutineSetDtoFromJson(Map<String, dynamic> json) => RoutineSetDto(
...
Map<String, dynamic> _$RoutineSetDtoToJson(RoutineSetDto instance) => <String, dynamic>{
  'id': instance.id,
