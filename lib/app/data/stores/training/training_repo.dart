...
import 'package:uniceps/app/data/sources/remote/dal_training/training_remote_source.dart';
...
import 'package:uniceps/app/domain/contracts/training_repo/i_training_service.dart';
import 'package:uniceps/core/errors/exceptions.dart';
import 'package:uniceps/core/errors/failure.dart';

class TrainingRepoImpl implements ITrainingService {
  TrainingRepoImpl({
    required this.local,
  ...
  final ITrainingLocalSource local;
  final ITrainingRemoteSource remote;
