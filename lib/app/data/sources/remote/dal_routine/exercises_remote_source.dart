...
class ExercisesRemoteSourceImpl implements IExercisesRemoteSourceContract {
  ...
  Future<List<MuscleGroupDto>> getExerciseGroups() async {
    return await _clientHelper.getListHandler<MuscleGroupDto>(API_V2, HTTP_MUSCLE_GROUPS, MuscleGroupDto.fromJson,
        needsHeader: false);
  }
  ...
  Future<List<ExerciseV2Dto>> getExercisesByGroup(MuscleGroupDto group) async {
    return await _clientHelper.getListHandler(API_V2, HTTP_EXERCISES, ExerciseV2Dto.fromJson,
