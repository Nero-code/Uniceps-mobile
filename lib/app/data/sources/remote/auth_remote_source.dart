...
abstract class RemoteAuthSource {
  Future<void> verifyEmail({required String email}); // MIGRATION DONE
  Future<UserModel> verifyCodeSent(
      {required String code,
      required String email,
      required String notifyToken}); // MIGRATION DONE

  Future<void> logout(); // MIGRATION DONE
  Future<bool> deleteAccount(); // MIGRATION DONE

  Future<void> uploadPlayerInfo({required PlayerModel player}); // Duplicated
