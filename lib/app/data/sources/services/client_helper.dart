...
abstract class ClientHelper {
  ...
  Future<T?> postHandler<T extends BaseDTO>(
      String urlPart, Map<String, dynamic> body,
      {T Function(Map<String, dynamic> json)? fromJson,
      void Function(Map<String, dynamic> body)? orElse});

  Future<void> putHandler(String urlPart, Map<String, dynamic> body);
  Future<void> deleteHandler(String urlPart, Map<String, dynamic> body);
}
