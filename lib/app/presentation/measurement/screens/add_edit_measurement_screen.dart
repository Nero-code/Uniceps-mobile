            ...
            children: [
                ...
                children: [
                  ...
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.nick,
                        onPositive: (val) => setState(() => measure.addAll({"neck": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.height,
                        onPositive: (val) => setState(() => measure.addAll({"height": val})),
                      ),
                    ),
                  ),
                ],
                ...
                children: [
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.lArm,
                        onPositive: (val) => setState(() => measure.addAll({"l_arm": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.chest,
                        onPositive: (val) => setState(() => measure.addAll({"chest": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.rArm,
                        onPositive: (val) => setState(() => measure.addAll({"r_arm": val})),
                      ),
                    ),
                  ),
                ],
                ...
                children: [
                  ...
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.waist,
                        onPositive: (val) => setState(() => measure.addAll({"waist": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                ...
                children: [
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.lLeg,
                        onPositive: (val) => setState(() => measure.addAll({"l_leg": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.hips,
                        onPositive: (val) => setState(() => measure.addAll({"hips": val})),
                      ),
                    ),
                  ),
                  MeasureWidget(
                    ...
                    onPressed: () => showDialog(
                      ...
                      builder: (_) => SetMeasureDialog(
                        title: locale.rLeg,
                        onPositive: (val) => setState(() => measure.addAll({"r_leg": val})),
                      ),
                    ),
                  ),
                ],
              ...
              MeasureWidget(
                ...
                onPressed: () => showDialog(
                  ...
                  builder: (_) => SetMeasureDialog(
                    title: locale.hips,
                    onPositive: (val) => setState(() => measure.addAll({"weight": val})),
                  ),
                ),
              ),
