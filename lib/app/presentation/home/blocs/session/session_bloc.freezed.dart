...
class _$StartSessionImpl implements _StartSession {
  const _$StartSessionImpl(this.dayId);
  ...
  @override
  String toString() {
    return 'SessionEvent.startSession(dayId: $dayId)';
  }
...
abstract class _StartSession implements SessionEvent {
  const factory _StartSession(final int dayId) = _$StartSessionImpl;
...
class _$StopSessionImpl implements _StopSession {
  const _$StopSessionImpl(this.session);
  ...
  @override
  String toString() {
    return 'SessionEvent.stopSession(session: $session)';
  }
...
abstract class _StopSession implements SessionEvent {
  const factory _StopSession(final TSession session) = _$StopSessionImpl;
