...
class _Initial implements ExerciseDetailsState {
  const _Initial();
...
@override
String toString() {
  return 'ExerciseDetailsState.initial()';
}
...
class _Success implements ExerciseDetailsState {
  const _Success({required this.result});
  

 final  ExerciseDetailsResult result;
...
@override
String toString() {
  return 'ExerciseDetailsState.success(result: $result)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $ExerciseDetailsStateCopyWith<$Res> {
  factory _$SuccessCopyWith(_Success value, $Res Function(_Success) _then) = __$SuccessCopyWithImpl;
@useResult
$Res call({
 ExerciseDetailsResult result
});
...
class _Failure implements ExerciseDetailsState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Failure&&(identical(other.f, f) || other.f == f));
}
...
@override
String toString() {
  return 'ExerciseDetailsState.failure(f: $f)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $ExerciseDetailsStateCopyWith<$Res> {
